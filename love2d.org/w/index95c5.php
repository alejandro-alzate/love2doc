...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://love2d.org/wiki/Special:ExportRDF/World-3AsetCallbacks">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2024-04-07T22:43:38+00:00</swivt:creationDate>
	...
	<swivt:Subject rdf:about="http://love2d.org/wiki/Special:URIResolver/World-3AsetCallbacks">
		...
		<property:Description rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Sets functions to be called when shapes collide.</property:Description>
		<property:PrettySince rdf:resource="&wiki;0.8.0"/>
		<property:Since rdf:resource="&wiki;000"/>
		<property:Since rdf:resource="&wiki;080"/>
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2022-10-20T07:45:34Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2459872.8233102</property:Modification_date-23aux>
	...
	<swivt:Subject rdf:about="http://love2d.org/wiki/Special:URIResolver/Contact">
		...
		<property:parent rdf:resource="&wiki;World-3AsetCallbacks"/>
	</swivt:Subject>
