...
<head>
<meta charset="UTF-8"/>
<title>Talk:stateful.lua - LOVE</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"Talk","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":1,"wgPageName":"Talk:stateful.lua","wgTitle":"stateful.lua","wgCurRevisionId":0,"wgRevisionId":0,"wgArticleId":0,"wgIsArticle":true,"wgIsRedirect":false,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":false,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Talk:stateful.lua","wgRelevantArticleId":0,"wgRequestId":"5034a896af5d27eeb6e32e7f","wgIsProbablyEditable":false,"wgRelevantPageIsProbablyEditable":false,"wgRestrictionCreate":[]});mw.loader.state({"site.styles":"ready","noscript":"ready","user.styles":"ready","user":"ready","user.options":"ready","user.tokens":"loading","ext.smw.style":"ready","ext.smw.tooltip.styles":"ready","mediawiki.legacy.shared":"ready","mediawiki.legacy.commonPrint":"ready","mediawiki.sectionAnchor":"ready","mediawiki.skinning.interface":"ready","mediawiki.skinning.content.externallinks":"ready","skins.love.styles":"ready"});mw.loader.implement("user.tokens@17jx9nu",function($,jQuery,require,module){/*@nomin*/mw.user.tokens.set({"editToken":"+\\","patrolToken":"+\\","watchToken":"+\\","csrfToken":"+\\"});
...
<link rel="alternate" type="application/rdf+xml" title="Talk:stateful.lua" href="/w/index.php?title=Special:ExportRDF/Talk:stateful.lua&amp;xmlmime=rdf"/>
...
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-1 ns-talk page-Talk_stateful_lua rootpage-Talk_stateful_lua skin-love action-view"><div id="globalWrapper">
		<div id="column-content">
			...
			<div>
				<ul>
				<li id="ca-nstab-main"><a href="/wiki/stateful.lua" title="View the content page [c]" accesskey="c">Page</a></li>
				<li id="ca-talk" class="selected new"><a href="/w/index.php?title=Talk:stateful.lua&amp;action=edit&amp;redlink=1" rel="discussion" title="Discussion about the content page (page does not exist) [t]" accesskey="t">Discussion</a></li>
				</ul>
							</div>
		</div>
	
				<h1 id="firstHeading" class="firstHeading" lang="en">Talk:stateful.lua</h1>
...
You can <a href="/wiki/Special:Search/stateful.lua" title="Special:Search/stateful.lua">search for this page title</a> in other pages, or <span class="plainlinks"><a rel="nofollow" class="external text" href="http://love2d.org/w/index.php?title=Special:Log&amp;page=Talk:stateful.lua">search the related logs</a></span>, but you do not have permission to create this page.
</p>
</div>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://love2d.org/wiki/Talk:stateful.lua">http://love2d.org/wiki/Talk:stateful.lua</a>"</div>
		...
		<div id="column-one">
			<div class="portlet" id="p-personal" role="navigation">
				...
				<div class="pBody">
					<ul>
													<li id="pt-login"><a href="/w/index.php?title=Special:UserLogin&amp;returnto=Talk%3Astateful.lua" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											<li id="t-whatlinkshere"><a href="/wiki/Special:WhatLinksHere/Talk:stateful.lua" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
											<li id="t-specialpages"><a href="/wiki/Special:SpecialPages" title="A list of all special pages [q]" accesskey="q">Special pages</a></li>
											<li id="t-print"><a href="/w/index.php?title=Talk:stateful.lua&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
											<li id="t-info"><a href="/w/index.php?title=Talk:stateful.lua&amp;action=info" title="More information about this page">Page information</a></li>
									</ul>
							</div>
		</div>
