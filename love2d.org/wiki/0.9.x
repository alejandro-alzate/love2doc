...
<link rel="alternate" type="application/rdf+xml" title="0.9.x" href="/w/index.php?title=Special:ExportRDF/0.9.x&amp;xmlmime=rdf"/>
...
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-0_9_x rootpage-0_9_x skin-love action-view"><div id="globalWrapper">
		<div id="column-content">
			...
			<div>
				<ul>
				<li id="ca-nstab-main" class="selected new"><a href="/w/index.php?title=0.9.x&amp;action=edit&amp;redlink=1" title="View the content page (page does not exist) [c]" accesskey="c">Page</a></li>
				<li id="ca-talk" class="new"><a href="/w/index.php?title=Talk:0.9.x&amp;action=edit&amp;redlink=1" rel="discussion" title="Discussion about the content page (page does not exist) [t]" accesskey="t">Discussion</a></li>
				</ul>
							</div>
		</div>
	
				<h1 id="firstHeading" class="firstHeading" lang="en">0.9.x</h1>
...
You can <a href="/wiki/Special:Search/0.9.x" title="Special:Search/0.9.x">search for this page title</a> in other pages, or <span class="plainlinks"><a rel="nofollow" class="external text" href="http://love2d.org/w/index.php?title=Special:Log&amp;page=0.9.x">search the related logs</a></span>, but you do not have permission to create this page.
</p>
</div>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://love2d.org/wiki/0.9.x">http://love2d.org/wiki/0.9.x</a>"</div>
		...
		<div id="column-one">
			<div class="portlet" id="p-personal" role="navigation">
				...
				<div class="pBody">
					<ul>
													<li id="pt-login"><a href="/w/index.php?title=Special:UserLogin&amp;returnto=0.9.x" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											<li id="t-whatlinkshere"><a href="/wiki/Special:WhatLinksHere/0.9.x" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
											<li id="t-specialpages"><a href="/wiki/Special:SpecialPages" title="A list of all special pages [q]" accesskey="q">Special pages</a></li>
											<li id="t-print"><a href="/w/index.php?title=0.9.x&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
											<li id="t-info"><a href="/w/index.php?title=0.9.x&amp;action=info" title="More information about this page">Page information</a></li>
											<li id="t-smwbrowselink"><a href="/wiki/Special:Browse/:0.9.x" rel="search">Browse properties</a></li>
									</ul>
							</div>
		</div>
